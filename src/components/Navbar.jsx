    ...
    return(
        <nav id='navbar' className="navbar  fixed top-0 left-0 w-full z-50 flex items-center lg:px-24 h-20 bg-blue-50 backdrop-blur-md text-slate-700">
            <div className="heading flex flex-1">
                <div className="font-bold text-xl pl-8 ">Satya<span className="text-blue-500">Narayana</span></div>
            </div>
        ...
        <ul className="md:hidden w-[200px] animate-navright flex flex-col items-center gap-6 pb-6 bg-blue-50 shadow-lg absolute top-16 right-10">
          ...
          <a href="#Contact" className="px-4 py-2 bg-blue-500 text-white rounded-lg">
            Contact
          </a>
        </ul>
      )}
