...
const SkillCard = ({ title, image, skills,index }) => {
  ...
  return (
    <div style={{animationDelay:`${index*0.12}s`}} className={`skillcard border border-slate-200 rounded-xl w-full bg-white shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] overflow-hidden ${animationclass} animate-view `}>
