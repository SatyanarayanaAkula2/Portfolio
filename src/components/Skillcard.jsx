...
const SkillCard = ({ title, image, skills }) => {
  ...
  return (
    <div className="skillcard border border-slate-200 rounded-xl bg-white shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] overflow-hidden">
