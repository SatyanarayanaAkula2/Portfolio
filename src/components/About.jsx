...
export default function About(){
    return(
        <section className='about py-8'>
            ...
            <div className='main grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                <div className='flex justify-center'>
                    <img src='src/assets/frontend.png'/>
                </div>

                <div className='content md:w-3/4 text-l border bg-blue-500/20 backdrop-blur-md border-blue-200/30 shadow-md hover:translate-y-1 hover:shadow-xl transition-all duration-300 p-16 m-4 rounded-xl'>
            ...
            <div className='bg-blue-50 py-16'>
                ...
                <div className='py-8 flex gap-6 justify-center'>
                    ...
                    <button className='btn'>GeeksForGeeks</button>
                </div>
            </div>
