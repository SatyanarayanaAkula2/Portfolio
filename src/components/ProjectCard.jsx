...
const ProjectCard=({title,image,description,tech,github,livelink,features})=>{
    return(
        <div className="project-card bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-lg hover:translate-y-1 transition p-6 flex flex-col gap-6 items-center lg:w-[45%] sm:w-3/4 mx-auto my-12  overflow-y-auto text-sm">
