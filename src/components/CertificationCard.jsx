...
export default function CertificationCard({title,logo,link,completion,skills,issuer,color}){
    const colors={
    ...
    return(
        <div className={`certfy-card relative border  border-2 rounded-xl  shadow-sm hover:translate-y-1 hover:shadow-xl transition-all duration-300 ${colors[color][0]} py-8 px-12 text-center flex flex-col gap-6 max-w-md w-full`}>
